...
- General
    ...
    - [Internationalization](https://github.com/jpomykala/awesome-i18n#readme) - I18n resources for all kind of languages and frameworks.
    - [Images](https://github.com/heyalexej/awesome-images#readme) - Amazingly free (stock) photo resources inspired by all the other  s.
    - [Gradient Boosting Papers](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers#readme) - Gradient boosting research papers with implementations.
    - [GitHub](https://github.com/Kikobeats/awesome-github#readme) - An exquisite secrets.
    - [Git](https://github.com/dictcp/awesome-git#readme) - Amazingly Git tools, resources and shiny things.
    - [GIF: by @Kikobeats](https://github.com/Kikobeats/awesome-gif#readme) - Gif's resources.
    - [Frontend: by @moklick](https://github.com/moklick/frontend-stuff#readme) - A continuously expanded frameworks, libraries and tools I used/want to use for building things on the web. Mostly JavaScript.
    - [Fraud Detection Papers](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers#readme) - Data mining papers about fraud detection.
