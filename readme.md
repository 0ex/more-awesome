...
- [Ruby Events (Conferences, Camps, Meetups, etc.)](https://github.com/planetruby/conferences)
...
- [Data visualization tools](https://github.com/javierluraschi/awesome-dataviz)
