...
- [Eclipse](https://github.com/hrj/awesome-eclipse)This is a list of "awesome" lists. An awesome list is a list of resources and starting points for a particular topic.
